    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100vh' }}>
      ...
      >
        <input
          ...
          className="w-full p-2 border border-gray-300 rounded-lg shadow-inner focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
        ...
        <div className="flex w-full space-x-3">
          ...
          <button
            onClick={handleSave}
            disabled={isSaving || !landingPageName}
            className="p-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
          >
